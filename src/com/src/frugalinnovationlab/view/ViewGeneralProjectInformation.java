...
public class ViewGeneralProjectInformation extends javax.swing.JPanel {
    ...
    private void printInfoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printInfoButtonActionPerformed
        ...
        printTextField.setFont(new java.awt.Font("Helvetica Neue", 0, 14)); // NOI18N
        String newline = "\r\n";
        String printText = "";
        printText = printText.concat("Project Name : " +projectNameTextField.getText());        
        printText = printText.concat(newline);
        printText = printText.concat(newline);
        printText = printText.concat("Short Description : " +shortDescTextField.getText());        
        printText = printText.concat(newline);
        printText = printText.concat(newline);
        printText = printText.concat("General Description :" +genDescTextArea.getText());        
        printText = printText.concat(newline);
        printText = printText.concat(newline);
        printText = printText.concat("Status : " +statusTextField.getText());        
        printText = printText.concat(newline);
        printText = printText.concat(newline);
        printText = printText.concat("Categories : " +categoryTextArea.getText());        
        printText = printText.concat(newline);
        printText = printText.concat(newline);
        printText = printText.concat("Location : " +locationTextField.getText());
        printText = printText.concat(newline);
        printText = printText.concat(newline);
        printText = printText.concat("Start Date : " +startDateTextField.getText());
        printText = printText.concat(newline);
        printText = printText.concat(newline);
        printText = printText.concat("End Date : " +endDateTextField.getText());
        printText = printText.concat(newline);
        printText = printText.concat(newline);
        printText = printText.concat("Scope : " +scopeTextField.getText());
        printText = printText.concat(newline);
        printText = printText.concat(newline);
        printText = printText.concat("Outcome : " +outcomeTextArea.getText());
        printText = printText.concat(newline);
        printText = printText.concat(newline);
        System.out.println("printText : " +printText);
        printTextField.setText(printText);
...
//If user does not hit cancel then print.
        if (preformat != postformat) {
            ...
            if (pjob.printDialog()) {
                try {
                    //pjob.print();
                    printTextField.print();
                    //shortDescTextField.print();
