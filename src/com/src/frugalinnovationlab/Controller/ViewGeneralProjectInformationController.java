 ...
 */
public class ViewGeneralProjectInformationController {
    private ViewGeneralProjectInformation gui;
    private EditGeneralProjectInformationModel editGeneralProjectInformationModel;

    public ViewGeneralProjectInformationController(ViewGeneralProjectInformation gui) {
        this.gui = gui;
